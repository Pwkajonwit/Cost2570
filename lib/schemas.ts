...
export const FORM_SCHEMAS: Record<string, FieldSchema[]> = {
  [TABLES.DATA]: [
    ...
    { name: "ชื่อเครื่องมือ", type: "EnumList", values: ["สว่านเจาะเหล็กไฟฟ้า", "สว่านเจาะปูน Rotary", "ลูกหมูขนาด 4\"", "ลูกหมูขนาด 7\"", "ไฟเบอร์ตัดเหล็ก"], showIf: { column: "ประเภท", equals: "7.เครื่องมือ" } },
    ...
    { name: "หัก", type: "Enum", values: ["1", "3", "5"], showIf: { column: "ประเภท", in: ["2.ค่าแรง", "8.อื่นๆ"] } },
